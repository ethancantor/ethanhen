...
// uploads
export { default as DefaultUpload } from './components/uploads/DefaultUpload.svelte';
export { default as UploadPage } from './components/uploads/UploadPage.svelte';
export { default as UploadWithFiles } from './components/uploads/UploadWithFiles.svelte';
...
export { default as MenuIcon } from './components/window/MenuIcon.svelte';
